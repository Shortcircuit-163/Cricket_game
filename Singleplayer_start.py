...
def start_match_singleplayer(name):
    ...
    bat = tk.Frame(player_info)
    bat.grid(row=0, column=0, pady = 100)
    ...
    bow = tk.Frame(player_info)
    bow.grid(row=0, column=1, pady = 100)
    ...
    wic = tk.Frame(player_info)
    wic.grid(row=0, column=2, pady = 100)
    wicket_keepers = Label(wic, text='Wicket Keepers', background='light grey', font=('Times New Roman', 20, 'bold'))
    ...
    all = tk.Frame(player_info)
    all.grid(row=0, column=3, pady = 100)
    ...
    wice = tk.Frame(player_info)
    wice.grid(row=0, column=4, pady = 100)
    ...
    run = tk.Frame(player_info)
    run.grid(row=1, column=0, pady = 100)
    ...
    eco = tk.Frame(player_info)
    eco.grid(row=1, column=1)
    economy_label = Label(eco, text='Economy', background='light grey', font=('Times New Roman', 20, 'bold'))
    ...
    inn = tk.Frame(player_info)
    inn.grid(row=1, column=2)
    innings_label = Label(inn, text='Innings', background='grey', font=('Times New Roman', 20, 'bold'))
    ...
    batt = tk.Frame(player_info)
    batt.grid(row=1, column=3)
    batting_avg = Label(batt, text='Batting Average', background='light grey', font=('Times New Roman', 20, 'bold'))
    ...
    bowl = tk.Frame(player_info)
    bowl.grid(row=1, column=4)
    bowling_avg = Label(bowl, text='Bowling Average', background='grey', font=('Times New Roman', 20, 'bold'))
    ...
    bat_avg = tk.Frame(player_info)
    bat_avg.grid(row=2, column=1, pady = 100)
    batting_overs_label = Label(bat_avg, text='Batting Overs', background='grey', font=('Times New Roman', 20, 'bold'))
    batting_overs_label.grid(row=0, column=0)
    batting_overs_value = Label(bat_avg, text=batting_overs, background='grey', font=('Times New Roman', 30, 'bold'))
    batting_overs_value.grid(row=1, column=0)

    bowl_avg = tk.Frame(player_info)
    bowl_avg.grid(row=2, column=2)
    bowling_overs_label = Label(bowl_avg, text='Bowling Overs', background='light grey', font=('Times New Roman', 20, 'bold'))
    bowling_overs_label.grid(row=0, column=0)
    bowling_overs_value = Label(bowl_avg, text=bowling_overs, background='light grey', font=('Times New Roman', 30, 'bold'))
    bowling_overs_value.grid(row=1, column=0)

    tot = tk.Frame(player_info)
    tot.grid(row=2, column=3)
